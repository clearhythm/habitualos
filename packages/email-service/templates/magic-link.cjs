function render({ appName, verifyUrl, primaryColor }) {
  return {
      ...
      <div style="background: #0d0c1a; padding: 3rem 1.5rem; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
        <div style="max-width: 440px; margin: 0 auto;">
          ...
          <div style="background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 16px; padding: 2rem 1.75rem; text-align: left;">
            <p style="font-family: Georgia, 'Times New Roman', serif; font-size: 1.625rem; font-weight: 300; color: #e5e3f5; margin: 0 0 0.25rem; letter-spacing: 0.02em;">${appName}</p>
            <p style="font-size: 0.875rem; color: rgba(156,163,175,0.65); margin: 0 0 1.75rem;">Sign-in link</p>
            ...
            <a href="${verifyUrl}"
               style="display: inline-block; padding: 0.75rem 2rem; background: transparent; color: ${primaryColor}; text-decoration: none; border-radius: 100px; border: 1.5px solid ${primaryColor}; font-family: Georgia, 'Times New Roman', serif; font-size: 1rem;">
              sign in
            </a>
          ...
          <p style="font-size: 0.7rem; color: rgba(156,163,175,0.3); text-align: center; margin: 1.5rem 0 0; line-height: 1.6;">
            ${appName} · 114 Cress Road, Santa Cruz, CA 95060, USA
          </p>
