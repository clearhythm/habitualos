 ...
 *
 * Inbound address format: jobs+{signalId}@signal.habitualos.com
 */
...
exports.handler = async (event) => {
  ...
  const { from, to, subject, html, text, date } = payload;

  // Extract signalId from to address: jobs+erik@signal... → "erik"
